...
public class GerenteControllerTests : BaseControllerTests
{
    ...
    public async Task ObterGerentes_DeveRetornarGerentesPaginados()
    {
        ...
        var gerentesEsperados = new RespostaPaginada<RepresentanteModel>
        {
        ...
        var mockClient = MockHttpMessageHandler.CreateMockClient(
            HttpStatusCode.OK,
            JsonSerializer.Serialize(gerentesEsperados, _jsonOpcoes)
        );
        ...
        // Act
        var result = await controller.ObterGerentes(queryObject, CancellationToken.None);
    ...
    [Fact]
    public async Task ObterGerentes_DeveRetornarListaVazia_QuandoNaoExistemGerentes()
    {
        // Arrange
        var queryObject = new FiltroPadraoQuery
        {
    ...
    [Fact]
    public async Task ObterGerentes_DeveTratarPaginacao()
    {
        // Arrange
        var queryObject = new FiltroPadraoQuery
        {
